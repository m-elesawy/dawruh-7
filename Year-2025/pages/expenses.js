// =======================
// كود صفحة المصروفات العمومية (masrufat) مع التعليقات والتوضيحات
// =======================
...
function getMasrufatPageHtml() {
    ...
    return `
        <div class="mt-4 mb-4 p-3 bg-white rounded shadow-sm">
            <h4 class="mb-3 text-primary">تقرير المصروفات العمومية</h4>
            <div class="alert alert-info mb-4">
                جميع المصروفات المسجلة للعمارة مع إجمالي الصرف.
            </div>
            <div class="d-flex justify-content-end mb-2">
                <button id="printMasrufat" class="btn btn-outline-success">طباعة تقرير المصروفات</button>
            </div>
            <div id="masrufatDiv" class="table-responsive mb-4">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ${rows || `<tr><td colspan="3" class="text-center">لا توجد مصروفات مُسجلة</td></tr>`}
